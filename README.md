...
7. [Part 3 – Logging into the VM & Inspecting Logs](#part-3-logging-into-the-vm-and-inspecting-logs)
8. [Part 4 – Log Forwarding & KQL](#part-4-log-forwarding-and-kql)
9. [Part 5 – Log Enrichment & Location Data](#part-5-log-enrichment-and-location-data)
